            ...
            <Container>
              <nav>
                <ul>
                  ...
                  <li>
                    <NavLink
                      href="/license?ref=blkdspr-index"
                      target="_blank"
                      className="ml-1"
                    >
                      License
          ...
          <footer className="footer footer-big footer-white">
            <Container>
              <div className="content">
                <Row>
                  <Col md="4">
                    <h4>About Us</h4>
                    <p>
                      Virtual Dynamic Labs is a startup that creates design tools that
              ...
              <div className="copyright pull-right">
                Copyright © {new Date().getFullYear()} Virtual Dynamic Labs All Rights
                Reserved.
              </div>
            </Container>
          </footer>
