          ...
          <Row id="pricing">
            ...
            <Col className="ml-auto mr-auto" md="8">
              <p className="description mb-5 text-center">
                ...
                <b>
                  <a
                    href="/license?ref=blkdspr-presentation"
                    target="_blank"
              ...
              <Row>
                  ...
                  <Card className="card-pricing card-plain card-primary">
                    <CardBody>
                      ...
                      <Button
                        className="btn-round"
                        color="info"
                        href="/buy/blk-design-system-pro-react?ref=blkdspr-presentation"
                        target="_blank"
                      >
                        Buy Now!
                      </Button>
                ...
                <Col xs="12" className="text-center mt-4">
                  <small>
                    * The above prices might suffer changes on the Virtual Dynamic Labs
                    platform
                  </small>
                </Col>
              </Row>
